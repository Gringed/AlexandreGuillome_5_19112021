...
function send(e) {
  ...
  const regexFirstLastNameCity = (value) => {
    return /^[a-zA-Z\séè-]{3,25}$/.test(value);
  }
  ...
  function checkPrenom(){
    ...
    if(regexFirstLastNameCity(prenom)){
      ...
      document.getElementById("firstNameErrorMsg").textContent = 'Veuillez entrer un prénom correct sans nombre, 3 à 25 caractères';
      return false;
    }
  }
  ...
  function checkNom(){
    ...
    if(regexFirstLastNameCity(nom)){
      ...
      document.getElementById("lastNameErrorMsg").textContent = 'Veuillez entrer un nom correct sans nombre, 3 à 25 caractères';
      return false;
    }
  }
